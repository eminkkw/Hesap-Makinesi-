...
while True:
    soru=input("Yapmak İstediğiniz işlemin numarasını lütfen yazınız 1-5 Hesap Makinesinden Çıkış Yapabilmek İçin Çıkış Yazmalısın\t")
    if soru=="Çıkış ":
        ...
        try:
            ...
            print("Lütfen Sadece sayıyı yazınız")